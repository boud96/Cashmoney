...
def delete_sample_data():
    ...
    counts = {
        "transactions": Transaction.objects.filter(import_batch__in=sample_imports).count(),
        "imports": sample_imports.count(),
        "keywords": Keyword.objects.filter(name__startswith=SAMPLE_PREFIX).count(),
        "bank_accounts": BankAccount.objects.filter(name__startswith=SAMPLE_PREFIX).count(),
        "csv_mappings": CSVMapping.objects.filter(name__startswith=SAMPLE_PREFIX).count(),
...
def create_keywords(subcategories, tags):
    specs = [
        ("Salary", ["salary", "payroll"], "Income", "Salary", None, False, ["Recurring"]),
        ("Refund", ["refund"], "Income", "Refund", None, False, ["Demo Import"]),
        ("Groceries", ["groceries", "tesco"], "Food", "Groceries", WantNeedInvestment.NEED, False, ["Family"]),
        ("Restaurants", ["restaurant", "bistro"], "Food", "Restaurants", WantNeedInvestment.WANT, False, ["Demo Import"]),
        ("Coffee", ["coffee"], "Food", "Coffee", WantNeedInvestment.WANT, False, ["Demo Import"]),
        ("Rent", ["rent"], "Home", "Rent", WantNeedInvestment.NEED, False, ["Recurring"]),
        ("Utilities", ["electricity", "internet"], "Home", "Utilities", WantNeedInvestment.NEED, False, ["Recurring"]),
        ("Travel", ["hotel", "flight"], "Lifestyle", "Travel", WantNeedInvestment.WANT, False, ["Vacation"]),
        ("Investment", ["investment", "etf"], "Savings", "Investment", WantNeedInvestment.INVESTMENT, False, ["Recurring"]),
        ("Internal Transfer", ["transfer", "savings"], None, None, None, True, ["Demo Import"]),
    ]

    for priority, spec in enumerate(specs, start=1):
        label, terms, category_label, subcategory_label, wni, is_ignored, tag_labels = spec
        subcategory = None
...
def create_sample_transactions(mapping, accounts):
    ...
    rows = [
        ("sample-001", "2026-01-02", "Sample - Salary January", "82000.00", "Sample Payroll", "9000000000/0100", "Incoming payment", "salary", ""),
        ("sample-002", "2026-01-04", "Sample - Tesco groceries", "-1842.40", "Sample Tesco", "8100000000/0100", "Card payment", "groceries", ""),
        ("sample-003", "2026-01-06", "Sample - Apartment rent", "-28000.00", "Sample Landlord", "8300000000/0100", "Standing order", "rent", ""),
        ("sample-004", "2026-01-11", "Sample - Coffee with friend", "-139.00", "Sample Coffee Bar", "8600000000/0100", "Card payment", "coffee", ""),
        ("sample-005", "2026-01-18", "Sample - Transfer to savings", "-12000.00", "Sample Savings", "3333333333/0100", "Transfer", "transfer savings", ""),
        ("sample-006", "2026-02-01", "Sample - Salary February", "82000.00", "Sample Payroll", "9000000000/0100", "Incoming payment", "salary", ""),
        ("sample-007", "2026-02-03", "Sample - Electricity bill", "-2150.00", "Sample Power", "8500000000/0100", "Direct debit", "electricity", ""),
        ("sample-008", "2026-02-07", "Sample - Family restaurant", "-1620.00", "Sample Bistro", "8200000000/0100", "Card payment", "restaurant", ""),
        ("sample-009", "2026-02-12", "Sample - Vacation hotel", "-5200.00", "Sample Hotel", "9200000000/0100", "Card payment", "hotel", "Vacation"),
        ("sample-010", "2026-02-20", "Sample - Investment ETF", "-9000.00", "Sample Broker", "9700000000/0100", "Transfer", "investment etf", ""),
        ("sample-011", "2026-03-01", "Sample - Salary March", "82000.00", "Sample Payroll", "9000000000/0100", "Incoming payment", "salary", ""),
        ("sample-012", "2026-03-02", "Sample - Grocery restock", "-2210.60", "Sample Tesco", "8100000000/0100", "Card payment", "groceries", ""),
        ("sample-013", "2026-03-06", "Sample - Internet package", "-799.00", "Sample Internet", "8500000001/0100", "Direct debit", "internet", ""),
        ("sample-014", "2026-03-10", "Sample - Flight refund", "1800.00", "Sample Airline", "9400000000/0100", "Incoming payment", "refund", "Vacation"),
        ("sample-015", "2026-03-22", "Sample - Transfer from savings", "6000.00", "Sample Savings", "3333333333/0100", "Transfer", "transfer savings", ""),
        ("sample-016", "2026-04-01", "Sample - Salary April", "82000.00", "Sample Payroll", "9000000000/0100", "Incoming payment", "salary", ""),
        ("sample-017", "2026-04-05", "Sample - Weekend restaurant", "-980.00", "Sample Bistro", "8200000000/0100", "Card payment", "restaurant", ""),
        ("sample-018", "2026-04-09", "Sample - Clothes shopping", "-2450.00", "Sample Store", "9600000000/0100", "Card payment", "shopping", ""),
        ("sample-019", "2026-04-14", "Sample - Coffee beans", "-420.00", "Sample Coffee Bar", "8600000000/0100", "Card payment", "coffee", ""),
        ("sample-020", "2026-04-25", "Sample - Transfer to shared household", "-4500.00", "Sample Shared Household", "2222222222/0100", "Transfer", "transfer savings", ""),
    ]
    ...
    for row in rows:
        original_id, date, description, amount, counterparty, account, kind, note, other = row
        csv_lines.append(
            ",".join(
                [
                    original_id,
